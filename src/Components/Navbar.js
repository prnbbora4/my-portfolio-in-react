                    ...
                    <div className="container">
                        ...
                        <div className={`collapse navbar-collapse ${show ? "show" : ""}`}>
                            ...
                            <form className="d-flex">
                                <NavLink to={{ pathname : "https://drive.google.com/file/d/1Kj8yDBQCjBjE-PEYZz1vwBYUiqa2_T_b/view?usp=sharing"}} target="_blank" className="btn btn-style btn-style-border">CV</NavLink>
